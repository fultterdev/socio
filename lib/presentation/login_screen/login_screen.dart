...
import 'package:socio3/domain/facebookauth/facebook_auth_helper.dart';
                          ...
                          Align(
                              ...
                              child: Container(
                                  ...
                                  decoration: AppDecoration
                                      .gradientDeeppurpleA200f2DeeppurpleA200f312,
                                  child: Column(
                                      mainAxisSize: MainAxisSize.min,
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Row(mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                          GestureDetector(
                                                                              ...
                                                                              child: Padding(padding: getPadding(top: 2, bottom: 3), child: CommonImageView(svgPath: ImageConstant.imgTwitter19X24, height: getVerticalSize(19.00), width: getHorizontalSize(24.00)))),
                                                                          Container(
